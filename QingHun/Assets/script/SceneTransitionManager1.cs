...
public class SceneTransitionManager1 : MonoBehaviour
{
    ...
    /// 加载场景并带有过渡效果
    /// </summary>
    public void LoadSceneWithTransition(string sceneName, System.Action onComplete = null)
    {
        if (!isTransitioning)
        {
    ...
    private IEnumerator Transition(string sceneName, System.Action onComplete)
    {
