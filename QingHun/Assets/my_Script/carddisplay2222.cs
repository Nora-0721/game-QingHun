...
public class CardDisplay2 : MonoBehaviour, IPointerClickHandler
{
    ...
    public void ToggleSelection()
    {
        ...
        // 通知GameManager
        GameManager3.Instance?.SelectCard(card, gameObject, isSelected);
    }
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        if (eventData.button == PointerEventData.InputButton.Left)
        {
            ...
            if (isSelected)
            {
                GameManager3.Instance?.AddSelectedCard(card, gameObject);
            }
            else
            {
                GameManager3.Instance?.RemoveSelectedCard(card, gameObject);
            }
        }
    }
