...
public class GameManager5 : MonoBehaviour
{
    ...
    public int initialBossHealth = 15;
    ...
    private void DrawCard()
    {
        ...
        cardObj.GetComponent<CardDisplay5>().Initialize(card);
    ...
    private void ResetAllCardsSelection()
    {
        ...
        {
            CardDisplay5 display = cardObj.GetComponent<CardDisplay5>();
            if (display != null)
            {
    ...
    private void UpdateUI()
    {
        ...
        if (playerHealth <= 0)
        {
            ...
            if (SceneTransitionManager1.Instance != null)
            {
                SceneTransitionManager1.Instance.LoadSceneWithTransition("cuoshi6");
            }
            else
            {
        ...
        if (bossHealth <= 0)
        {
            ...
            if (SceneTransitionManager1.Instance != null)
            {
                SceneTransitionManager1.Instance.LoadSceneWithTransition("pochu6");
            }
            else
            {
                SceneManager.LoadScene(videoSceneName2);
